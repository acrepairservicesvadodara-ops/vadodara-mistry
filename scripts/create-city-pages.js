...
export const metadata: Metadata = {
  ...
  description: "Professional AC repair, service & installation in ${city.name}, ${city.state}. Industrial & commercial AC service. 20+ years experience, 90-day warranty. Call +91 97272 57141",
  keywords: [
    "AC repair ${city.name}",
