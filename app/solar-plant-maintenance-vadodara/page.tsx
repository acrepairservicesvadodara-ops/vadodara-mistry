...
const keyword = {
  slug: "solar-plant-maintenance-vadodara",
  title: "Solar Plant Maintenance",
  description: "Solar plant maintenance",
  category: "solar" as const,
};

const category = "solar";
const config = categoryConfig["solar"];
const images = categoryImages["solar"];
const content = categoryContent["solar"];
const keywordContent = generateKeywordContent(keyword, "solar");
const extendedContent = generateExtendedContent(keyword, "solar");
const uniqueFAQs = generateUniqueFAQs(keyword, "solar");

// Schema data
const faqSchema = generateFAQSchema(uniqueFAQs);
const localBusinessSchema = generateLocalBusinessSchema("Solar Plant Maintenance");
const serviceSchema = generateServiceSchema(keyword);
const breadcrumbSchema = generateBreadcrumbSchema([
  { name: "Home", url: "https://vadodaramistry.com" },
  { name: "Solar", url: "https://vadodaramistry.com/solar-vadodara" },
  { name: "Solar Plant Maintenance", url: "https://vadodaramistry.com/solar-plant-maintenance-vadodara" },
]);

const relatedServices = allKeywords
  .filter((kw) => kw.category === "solar" && kw.slug !== "solar-plant-maintenance-vadodara")
  .slice(0, 8);

export const metadata: Metadata = {
  title: `Solar Plant Maintenance in Vadodara | Professional Solar Plant Maintenance Services - Vadodara Mistry`,
  description: `Looking for solar plant maintenance in Vadodara? Vadodara Mistry offers professional solar plant maintenance. ✓ 12+ Years Experience ✓ 10,000+ Happy Customers ✓ Best Prices ✓ Quality Work. Call +91 93139 82980`,
  keywords: [
    "Solar Plant Maintenance",
    "Solar Plant Maintenance Vadodara",
    "Solar Plant Maintenance services",
    "best solar plant maintenance",
    "solar plant maintenance near me",
    "solar plant maintenance cost Vadodara",
    "Vadodara Mistry",
  ],
  openGraph: {
    title: `Solar Plant Maintenance in Vadodara | Vadodara Mistry`,
    description: `Professional solar plant maintenance services in Vadodara. 12+ years experience, 10,000+ satisfied customers.`,
    url: "https://vadodaramistry.com/solar-plant-maintenance-vadodara",
...
export default function SolarPlantMaintenanceVadodaraPage() {
  return (
    <>
      {/* Schema Markup */}
      <Script
      ...
      <nav className="bg-gray-100 py-3">
        <div className="container mx-auto px-4">
          <ol className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <li>/</li>
            <li><Link href="/solar-vadodara" className="hover:text-orange-600">Solar</Link></li>
            <li>/</li>
            <li className="text-orange-600 font-medium">Solar Plant Maintenance</li>
          </ol>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-white">
              ...
              <h1 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6">
                Solar Plant Maintenance in Vadodara
              </h1>
              <p className="text-lg md:text-xl mb-6 text-white/90">
                Solar plant maintenance in Vadodara. Trusted by thousands of customers. 
              ...
              <div className="hidden md:flex flex-col sm:flex-row gap-4">
                ...
                <a
                  href={`https://wa.me/919313982980?text=Hi, I need Solar Plant Maintenance service in Vadodara`}
            ...
            <div className="bg-white rounded-2xl p-6 shadow-2xl">
              <BookingForm title={`Get Free Solar Plant Maintenance Quote`} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Choose Us for Solar Plant Maintenance?
          </h2>
          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                About Solar Plant Maintenance Services in Vadodara
              </h2>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                Why Solar Plant Maintenance Matters for Your Property
              </h3>
              <div className="text-gray-700 leading-relaxed space-y-4">
                <p>
                  Professional solar plant maintenance services are essential for maintaining and enhancing your property in Vadodara. 
                  Whether you own a residential property in Alkapuri, a commercial establishment in Sayajigunj, or an industrial 
                  facility in Makarpura GIDC, quality solar plant maintenance work ensures longevity, aesthetics, and value.
                </p>
                <p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Choose Vadodara Mistry for Solar Plant Maintenance?
          </h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Our Solar Plant Maintenance Process
          </h2>
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            We follow a systematic approach to ensure quality results for every solar plant maintenance project
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Solar Plant Maintenance Service Areas in Vadodara
          </h2>
          <p className="text-center text-gray-600 mb-12">
            We provide solar plant maintenance services across all Vadodara areas
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Frequently Asked Questions About Solar Plant Maintenance
          </h2>
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            Find answers to common questions about our solar plant maintenance services in Vadodara
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div>
              <h2 className="text-3xl font-bold mb-4">
                Book Solar Plant Maintenance Service Today
              </h2>
      ...
      <section className={`${config.gradient} py-16`}>
        <div className="container mx-auto px-4 text-center text-white">
          <h2 className="text-3xl font-bold mb-4">
            Need Solar Plant Maintenance Service in Vadodara?
          </h2>
