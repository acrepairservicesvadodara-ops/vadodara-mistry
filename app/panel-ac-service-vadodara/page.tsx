...
export const metadata: Metadata = {
  title: "Panel AC Service in Vadodara | Installation, Service & Repair | Atlas Aircon",
  description: "Panel AC repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 97272 57141",
  keywords: [
    "Panel AC Service Vadodara",
    "panel ac service",
    "Panel AC Service installation",
    "Panel AC Service service",
    "Panel AC Service repair",
    "best Panel AC Service service",
  ],
  alternates: {
    canonical: "https://atlasaircons.com/panel-ac-service-vadodara",
  },
};

const keywordData = {
  title: "Panel AC Service",
  slug: "panel-ac-service",
  description: "Panel AC repair",
  category: "Commercial"
};
...
export default function PanelACServicePage() {
  return (
    <>
      {/* Hero Section */}
