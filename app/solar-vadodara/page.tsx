...
export const metadata: Metadata = {
  ...
  description: "Professional solar panel installation in Vadodara. On-grid & off-grid solar systems with government subsidy. 25-year warranty. Call +91 93139 82980",
