...
export const metadata: Metadata = {
  ...
  description: "Professional plumber services in Vadodara. Expert pipe fitting, bathroom fitting, leak repair, drainage cleaning & more. 24/7 service. Call +91 93139 82980",
