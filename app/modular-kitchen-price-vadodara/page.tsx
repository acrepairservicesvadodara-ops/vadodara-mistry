...
const keyword = {
  slug: "modular-kitchen-price-vadodara",
  title: "Modular Kitchen Price",
  description: "Modular kitchen rates",
  category: "carpenter" as const,
};

const category = "carpenter";
const config = categoryConfig["carpenter"];
const images = categoryImages["carpenter"];
const content = categoryContent["carpenter"];
const keywordContent = generateKeywordContent(keyword, "carpenter");
const extendedContent = generateExtendedContent(keyword, "carpenter");
const uniqueFAQs = generateUniqueFAQs(keyword, "carpenter");

// Schema data
const faqSchema = generateFAQSchema(uniqueFAQs);
const localBusinessSchema = generateLocalBusinessSchema("Modular Kitchen Price");
const serviceSchema = generateServiceSchema(keyword);
const breadcrumbSchema = generateBreadcrumbSchema([
  { name: "Home", url: "https://vadodaramistry.com" },
  { name: "Carpenter", url: "https://vadodaramistry.com/carpenter-vadodara" },
  { name: "Modular Kitchen Price", url: "https://vadodaramistry.com/modular-kitchen-price-vadodara" },
]);

const relatedServices = allKeywords
  .filter((kw) => kw.category === "carpenter" && kw.slug !== "modular-kitchen-price-vadodara")
  .slice(0, 8);

export const metadata: Metadata = {
  title: `Modular Kitchen Price in Vadodara | Professional Modular Kitchen Price Services - Vadodara Mistry`,
  description: `Looking for modular kitchen price in Vadodara? Vadodara Mistry offers professional modular kitchen rates. ✓ 12+ Years Experience ✓ 10,000+ Happy Customers ✓ Best Prices ✓ Quality Work. Call +91 93139 82980`,
  keywords: [
    "Modular Kitchen Price",
    "Modular Kitchen Price Vadodara",
    "Modular Kitchen Price services",
    "best modular kitchen price",
    "modular kitchen price near me",
    "modular kitchen price cost Vadodara",
    "Vadodara Mistry",
  ],
  openGraph: {
    title: `Modular Kitchen Price in Vadodara | Vadodara Mistry`,
    description: `Professional modular kitchen price services in Vadodara. 12+ years experience, 10,000+ satisfied customers.`,
    url: "https://vadodaramistry.com/modular-kitchen-price-vadodara",
...
export default function ModularKitchenPriceVadodaraPage() {
  return (
    <>
      {/* Schema Markup */}
      <Script
      ...
      <nav className="bg-gray-100 py-3">
        <div className="container mx-auto px-4">
          <ol className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <li>/</li>
            <li><Link href="/carpenter-vadodara" className="hover:text-orange-600">Carpenter</Link></li>
            <li>/</li>
            <li className="text-orange-600 font-medium">Modular Kitchen Price</li>
          </ol>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-white">
              ...
              <h1 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6">
                Modular Kitchen Price in Vadodara
              </h1>
              <p className="text-lg md:text-xl mb-6 text-white/90">
                Modular kitchen rates in Vadodara. Trusted by thousands of customers. 
              ...
              <div className="hidden md:flex flex-col sm:flex-row gap-4">
                ...
                <a
                  href={`https://wa.me/919313982980?text=Hi, I need Modular Kitchen Price service in Vadodara`}
            ...
            <div className="bg-white rounded-2xl p-6 shadow-2xl">
              <BookingForm title={`Get Free Modular Kitchen Price Quote`} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Choose Us for Modular Kitchen Price?
          </h2>
          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                About Modular Kitchen Price Services in Vadodara
              </h2>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                Why Modular Kitchen Price Matters for Your Property
              </h3>
              <div className="text-gray-700 leading-relaxed space-y-4">
                <p>
                  Professional modular kitchen price services are essential for maintaining and enhancing your property in Vadodara. 
                  Whether you own a residential property in Alkapuri, a commercial establishment in Sayajigunj, or an industrial 
                  facility in Makarpura GIDC, quality modular kitchen price work ensures longevity, aesthetics, and value.
                </p>
                <p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Choose Vadodara Mistry for Modular Kitchen Price?
          </h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Our Modular Kitchen Price Process
          </h2>
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            We follow a systematic approach to ensure quality results for every modular kitchen price project
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Modular Kitchen Price Service Areas in Vadodara
          </h2>
          <p className="text-center text-gray-600 mb-12">
            We provide modular kitchen price services across all Vadodara areas
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Frequently Asked Questions About Modular Kitchen Price
          </h2>
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            Find answers to common questions about our modular kitchen price services in Vadodara
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div>
              <h2 className="text-3xl font-bold mb-4">
                Book Modular Kitchen Price Service Today
              </h2>
      ...
      <section className={`${config.gradient} py-16`}>
        <div className="container mx-auto px-4 text-center text-white">
          <h2 className="text-3xl font-bold mb-4">
            Need Modular Kitchen Price Service in Vadodara?
          </h2>
