...
const keyword = {
  slug: "havells-geyser-repair-vadodara",
  title: "Havells Geyser Repair",
  description: "Havells geyser service",
  category: "plumbing" as const,
};

const category = "plumbing";
const config = categoryConfig["plumbing"];
const images = categoryImages["plumbing"];
const content = categoryContent["plumbing"];
const keywordContent = generateKeywordContent(keyword, "plumbing");
const extendedContent = generateExtendedContent(keyword, "plumbing");
const uniqueFAQs = generateUniqueFAQs(keyword, "plumbing");

// Schema data
const faqSchema = generateFAQSchema(uniqueFAQs);
const localBusinessSchema = generateLocalBusinessSchema("Havells Geyser Repair");
const serviceSchema = generateServiceSchema(keyword);
const breadcrumbSchema = generateBreadcrumbSchema([
  { name: "Home", url: "https://vadodaramistry.com" },
  { name: "Plumbing", url: "https://vadodaramistry.com/plumbing-vadodara" },
  { name: "Havells Geyser Repair", url: "https://vadodaramistry.com/havells-geyser-repair-vadodara" },
]);

const relatedServices = allKeywords
  .filter((kw) => kw.category === "plumbing" && kw.slug !== "havells-geyser-repair-vadodara")
  .slice(0, 8);

export const metadata: Metadata = {
  title: `Havells Geyser Repair in Vadodara | Professional Havells Geyser Repair Services - Vadodara Mistry`,
  description: `Looking for havells geyser repair in Vadodara? Vadodara Mistry offers professional havells geyser service. ✓ 12+ Years Experience ✓ 10,000+ Happy Customers ✓ Best Prices ✓ Quality Work. Call +91 93139 82980`,
  keywords: [
    "Havells Geyser Repair",
    "Havells Geyser Repair Vadodara",
    "Havells Geyser Repair services",
    "best havells geyser repair",
    "havells geyser repair near me",
    "havells geyser repair cost Vadodara",
    "Vadodara Mistry",
  ],
  openGraph: {
    title: `Havells Geyser Repair in Vadodara | Vadodara Mistry`,
    description: `Professional havells geyser repair services in Vadodara. 12+ years experience, 10,000+ satisfied customers.`,
    url: "https://vadodaramistry.com/havells-geyser-repair-vadodara",
...
export default function HavellsGeyserRepairVadodaraPage() {
  return (
    <>
      {/* Schema Markup */}
      <Script
      ...
      <nav className="bg-gray-100 py-3">
        <div className="container mx-auto px-4">
          <ol className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <li>/</li>
            <li><Link href="/plumbing-vadodara" className="hover:text-orange-600">Plumbing</Link></li>
            <li>/</li>
            <li className="text-orange-600 font-medium">Havells Geyser Repair</li>
          </ol>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-white">
              ...
              <h1 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6">
                Havells Geyser Repair in Vadodara
              </h1>
              <p className="text-lg md:text-xl mb-6 text-white/90">
                Havells geyser service in Vadodara. Trusted by thousands of customers. 
              ...
              <div className="hidden md:flex flex-col sm:flex-row gap-4">
                ...
                <a
                  href={`https://wa.me/919313982980?text=Hi, I need Havells Geyser Repair service in Vadodara`}
            ...
            <div className="bg-white rounded-2xl p-6 shadow-2xl">
              <BookingForm title={`Get Free Havells Geyser Repair Quote`} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Choose Us for Havells Geyser Repair?
          </h2>
          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                About Havells Geyser Repair Services in Vadodara
              </h2>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                Why Havells Geyser Repair Matters for Your Property
              </h3>
              <div className="text-gray-700 leading-relaxed space-y-4">
                <p>
                  Professional havells geyser repair services are essential for maintaining and enhancing your property in Vadodara. 
                  Whether you own a residential property in Alkapuri, a commercial establishment in Sayajigunj, or an industrial 
                  facility in Makarpura GIDC, quality havells geyser repair work ensures longevity, aesthetics, and value.
                </p>
                <p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Choose Vadodara Mistry for Havells Geyser Repair?
          </h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Our Havells Geyser Repair Process
          </h2>
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            We follow a systematic approach to ensure quality results for every havells geyser repair project
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Havells Geyser Repair Service Areas in Vadodara
          </h2>
          <p className="text-center text-gray-600 mb-12">
            We provide havells geyser repair services across all Vadodara areas
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Frequently Asked Questions About Havells Geyser Repair
          </h2>
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            Find answers to common questions about our havells geyser repair services in Vadodara
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div>
              <h2 className="text-3xl font-bold mb-4">
                Book Havells Geyser Repair Service Today
              </h2>
      ...
      <section className={`${config.gradient} py-16`}>
        <div className="container mx-auto px-4 text-center text-white">
          <h2 className="text-3xl font-bold mb-4">
            Need Havells Geyser Repair Service in Vadodara?
          </h2>
