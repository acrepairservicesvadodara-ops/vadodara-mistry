...
export const metadata: Metadata = {
  title: "AC Repair Cost in Vadodara | Installation, Service & Repair | Atlas Aircon",
  description: "AC repair charges in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 97272 57141",
  keywords: [
    "AC Repair Cost Vadodara",
    "ac repair cost",
    "AC Repair Cost installation",
    "AC Repair Cost service",
    "AC Repair Cost repair",
    "best AC Repair Cost service",
  ],
  alternates: {
    canonical: "https://atlasaircons.com/ac-repair-cost-vadodara",
  },
};
