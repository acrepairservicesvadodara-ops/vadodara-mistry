...
const keyword = {
  slug: "canopy-vadodara",
  title: "Canopy",
  description: "Canopy installation",
...
const localBusinessSchema = generateLocalBusinessSchema("Canopy");
...
const breadcrumbSchema = generateBreadcrumbSchema([
  ...
  { name: "Canopy", url: "https://vadodaramistry.com/canopy-vadodara" },
]);

const relatedServices = allKeywords
  .filter((kw) => kw.category === "fabrication" && kw.slug !== "canopy-vadodara")
  .slice(0, 8);

export const metadata: Metadata = {
  title: `Canopy in Vadodara | Professional Canopy Services - Vadodara Mistry`,
  description: `Looking for canopy in Vadodara? Vadodara Mistry offers professional canopy installation. ✓ 12+ Years Experience ✓ 10,000+ Happy Customers ✓ Best Prices ✓ Quality Work. Call +91 93139 82980`,
  keywords: [
    "Canopy",
    "Canopy Vadodara",
    "Canopy services",
    "best canopy",
    "canopy near me",
    "canopy cost Vadodara",
    "Vadodara Mistry",
  ],
  openGraph: {
    title: `Canopy in Vadodara | Vadodara Mistry`,
    description: `Professional canopy services in Vadodara. 12+ years experience, 10,000+ satisfied customers.`,
    url: "https://vadodaramistry.com/canopy-vadodara",
...
export default function CanopyVadodaraPage() {
  return (
    <>
      {/* Schema Markup */}
      <Script
      ...
      <nav className="bg-gray-100 py-3">
        <div className="container mx-auto px-4">
          <ol className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <li>/</li>
            <li className="text-orange-600 font-medium">Canopy</li>
          </ol>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-white">
              ...
              <p className="text-lg md:text-xl mb-6 text-white/90">
                Canopy installation in Vadodara. Trusted by thousands of customers. 
              ...
              <div className="hidden md:flex flex-col sm:flex-row gap-4">
                ...
                <a
                  href={`https://wa.me/919313982980?text=Hi, I need Canopy service in Vadodara`}
            ...
            <div className="bg-white rounded-2xl p-6 shadow-2xl">
              <BookingForm title={`Get Free Canopy Quote`} />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                About Canopy Services in Vadodara
              </h2>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                Why Canopy Matters for Your Property
              </h3>
              <div className="text-gray-700 leading-relaxed space-y-4">
                <p>
                  Professional canopy services are essential for maintaining and enhancing your property in Vadodara. 
                  Whether you own a residential property in Alkapuri, a commercial establishment in Sayajigunj, or an industrial 
                  facility in Makarpura GIDC, quality canopy work ensures longevity, aesthetics, and value.
                </p>
                <p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Choose Vadodara Mistry for Canopy?
          </h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            We follow a systematic approach to ensure quality results for every canopy project
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Canopy Service Areas in Vadodara
          </h2>
          <p className="text-center text-gray-600 mb-12">
            We provide canopy services across all Vadodara areas
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            Find answers to common questions about our canopy services in Vadodara
          </p>
      ...
      <section className={`${config.gradient} py-16`}>
        <div className="container mx-auto px-4 text-center text-white">
          <h2 className="text-3xl font-bold mb-4">
            Need Canopy Service in Vadodara?
          </h2>
