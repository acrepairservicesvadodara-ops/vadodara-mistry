...
export const metadata: Metadata = {
  title: "Cassette AC Service in Vadodara | Installation, Service & Repair | Atlas Aircon",
  description: "Cassette AC maintenance in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 97272 57141",
  keywords: [
    "Cassette AC Service Vadodara",
    "cassette ac service",
    "Cassette AC Service installation",
    "Cassette AC Service service",
    "Cassette AC Service repair",
    "best Cassette AC Service service",
  ],
  alternates: {
    canonical: "https://atlasaircons.com/cassette-ac-service-vadodara",
  },
};
...
const keywordData = {
  ...
  description: "Cassette AC maintenance",
  category: "ACTypes"
};
...
export default function CassetteACServicePage() {
  return (
    <>
      {/* Hero Section */}
