...
const keyword = {
  slug: "gate-fabrication-vadodara",
  title: "Gate Fabrication",
  description: "Gate fabrication work",
...
const localBusinessSchema = generateLocalBusinessSchema("Gate Fabrication");
...
const breadcrumbSchema = generateBreadcrumbSchema([
  ...
  { name: "Gate Fabrication", url: "https://vadodaramistry.com/gate-fabrication-vadodara" },
]);

const relatedServices = allKeywords
  .filter((kw) => kw.category === "fabrication" && kw.slug !== "gate-fabrication-vadodara")
  .slice(0, 8);

export const metadata: Metadata = {
  title: `Gate Fabrication in Vadodara | Professional Gate Fabrication Services - Vadodara Mistry`,
  description: `Looking for gate fabrication in Vadodara? Vadodara Mistry offers professional gate fabrication work. ✓ 12+ Years Experience ✓ 10,000+ Happy Customers ✓ Best Prices ✓ Quality Work. Call +91 93139 82980`,
  keywords: [
    "Gate Fabrication",
    "Gate Fabrication Vadodara",
    "Gate Fabrication services",
    "best gate fabrication",
    "gate fabrication near me",
    "gate fabrication cost Vadodara",
    "Vadodara Mistry",
  ],
  openGraph: {
    title: `Gate Fabrication in Vadodara | Vadodara Mistry`,
    description: `Professional gate fabrication services in Vadodara. 12+ years experience, 10,000+ satisfied customers.`,
    url: "https://vadodaramistry.com/gate-fabrication-vadodara",
  ...
  return (
    <>
      ...
      <nav className="bg-gray-100 py-3">
        <div className="container mx-auto px-4">
          <ol className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <li>/</li>
            <li className="text-orange-600 font-medium">Gate Fabrication</li>
          </ol>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-white">
              ...
              <p className="text-lg md:text-xl mb-6 text-white/90">
                Gate fabrication work in Vadodara. Trusted by thousands of customers. 
              ...
              <div className="hidden md:flex flex-col sm:flex-row gap-4">
                ...
                <a
                  href={`https://wa.me/919313982980?text=Hi, I need Gate Fabrication service in Vadodara`}
            ...
            <div className="bg-white rounded-2xl p-6 shadow-2xl">
              <BookingForm title={`Get Free Gate Fabrication Quote`} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Choose Us for Gate Fabrication?
          </h2>
          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                About Gate Fabrication Services in Vadodara
              </h2>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                Why Gate Fabrication Matters for Your Property
              </h3>
              <div className="text-gray-700 leading-relaxed space-y-4">
                <p>
                  Professional gate fabrication services are essential for maintaining and enhancing your property in Vadodara. 
                  Whether you own a residential property in Alkapuri, a commercial establishment in Sayajigunj, or an industrial 
                  facility in Makarpura GIDC, quality gate fabrication work ensures longevity, aesthetics, and value.
                </p>
                <p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            We follow a systematic approach to ensure quality results for every gate fabrication project
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Gate Fabrication Service Areas in Vadodara
          </h2>
          <p className="text-center text-gray-600 mb-12">
            We provide gate fabrication services across all Vadodara areas
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Frequently Asked Questions About Gate Fabrication
          </h2>
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            Find answers to common questions about our gate fabrication services in Vadodara
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div>
              <h2 className="text-3xl font-bold mb-4">
                Book Gate Fabrication Service Today
              </h2>
      ...
      <section className={`${config.gradient} py-16`}>
        <div className="container mx-auto px-4 text-center text-white">
          <h2 className="text-3xl font-bold mb-4">
            Need Gate Fabrication Service in Vadodara?
          </h2>
