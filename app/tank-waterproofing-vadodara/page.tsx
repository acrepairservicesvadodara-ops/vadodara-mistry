...
const keyword = {
  slug: "tank-waterproofing-vadodara",
...
const localBusinessSchema = generateLocalBusinessSchema("Tank Waterproofing");
...
const breadcrumbSchema = generateBreadcrumbSchema([
  ...
  { name: "Tank Waterproofing", url: "https://vadodaramistry.com/tank-waterproofing-vadodara" },
]);

const relatedServices = allKeywords
  .filter((kw) => kw.category === "civil" && kw.slug !== "tank-waterproofing-vadodara")
  .slice(0, 8);

export const metadata: Metadata = {
  title: `Tank Waterproofing in Vadodara | Professional Tank Waterproofing Services - Vadodara Mistry`,
  description: `Looking for tank waterproofing in Vadodara? Vadodara Mistry offers professional water tank waterproofing. ✓ 12+ Years Experience ✓ 10,000+ Happy Customers ✓ Best Prices ✓ Quality Work. Call +91 93139 82980`,
  keywords: [
    "Tank Waterproofing",
    "Tank Waterproofing Vadodara",
    "Tank Waterproofing services",
    "best tank waterproofing",
    "tank waterproofing near me",
    "tank waterproofing cost Vadodara",
    "Vadodara Mistry",
  ],
  openGraph: {
    title: `Tank Waterproofing in Vadodara | Vadodara Mistry`,
    description: `Professional tank waterproofing services in Vadodara. 12+ years experience, 10,000+ satisfied customers.`,
    url: "https://vadodaramistry.com/tank-waterproofing-vadodara",
...
export default function TankWaterproofingVadodaraPage() {
  return (
    <>
      {/* Schema Markup */}
      <Script
      ...
      <nav className="bg-gray-100 py-3">
        <div className="container mx-auto px-4">
          <ol className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <li>/</li>
            <li className="text-orange-600 font-medium">Tank Waterproofing</li>
          </ol>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-white">
              ...
              <h1 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6">
                Tank Waterproofing in Vadodara
              </h1>
              <p className="text-lg md:text-xl mb-6 text-white/90">
                Water tank waterproofing in Vadodara. Trusted by thousands of customers. 
              ...
              <div className="hidden md:flex flex-col sm:flex-row gap-4">
                ...
                <a
                  href={`https://wa.me/919313982980?text=Hi, I need Tank Waterproofing service in Vadodara`}
            ...
            <div className="bg-white rounded-2xl p-6 shadow-2xl">
              <BookingForm title={`Get Free Tank Waterproofing Quote`} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Choose Us for Tank Waterproofing?
          </h2>
          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                About Tank Waterproofing Services in Vadodara
              </h2>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                Why Tank Waterproofing Matters for Your Property
              </h3>
              <div className="text-gray-700 leading-relaxed space-y-4">
                <p>
                  Professional tank waterproofing services are essential for maintaining and enhancing your property in Vadodara. 
                  Whether you own a residential property in Alkapuri, a commercial establishment in Sayajigunj, or an industrial 
                  facility in Makarpura GIDC, quality tank waterproofing work ensures longevity, aesthetics, and value.
                </p>
                <p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Choose Vadodara Mistry for Tank Waterproofing?
          </h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Our Tank Waterproofing Process
          </h2>
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            We follow a systematic approach to ensure quality results for every tank waterproofing project
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Tank Waterproofing Service Areas in Vadodara
          </h2>
          <p className="text-center text-gray-600 mb-12">
            We provide tank waterproofing services across all Vadodara areas
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Frequently Asked Questions About Tank Waterproofing
          </h2>
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            Find answers to common questions about our tank waterproofing services in Vadodara
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div>
              <h2 className="text-3xl font-bold mb-4">
                Book Tank Waterproofing Service Today
              </h2>
      ...
      <section className={`${config.gradient} py-16`}>
        <div className="container mx-auto px-4 text-center text-white">
          <h2 className="text-3xl font-bold mb-4">
            Need Tank Waterproofing Service in Vadodara?
          </h2>
