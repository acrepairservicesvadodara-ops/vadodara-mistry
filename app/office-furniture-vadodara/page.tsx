...
const keyword = {
  slug: "office-furniture-vadodara",
  title: "Office Furniture",
  description: "Office furniture making",
...
const localBusinessSchema = generateLocalBusinessSchema("Office Furniture");
...
const breadcrumbSchema = generateBreadcrumbSchema([
  ...
  { name: "Office Furniture", url: "https://vadodaramistry.com/office-furniture-vadodara" },
]);

const relatedServices = allKeywords
  .filter((kw) => kw.category === "carpenter" && kw.slug !== "office-furniture-vadodara")
  .slice(0, 8);

export const metadata: Metadata = {
  title: `Office Furniture in Vadodara | Professional Office Furniture Services - Vadodara Mistry`,
  description: `Looking for office furniture in Vadodara? Vadodara Mistry offers professional office furniture making. ✓ 12+ Years Experience ✓ 10,000+ Happy Customers ✓ Best Prices ✓ Quality Work. Call +91 93139 82980`,
  keywords: [
    "Office Furniture",
    ...
    "office furniture cost Vadodara",
    "Vadodara Mistry",
  ],
  openGraph: {
    title: `Office Furniture in Vadodara | Vadodara Mistry`,
    description: `Professional office furniture services in Vadodara. 12+ years experience, 10,000+ satisfied customers.`,
    url: "https://vadodaramistry.com/office-furniture-vadodara",
...
export default function OfficeFurnitureVadodaraPage() {
  return (
    <>
      {/* Schema Markup */}
      <Script
      ...
      <nav className="bg-gray-100 py-3">
        <div className="container mx-auto px-4">
          <ol className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <li>/</li>
            <li className="text-orange-600 font-medium">Office Furniture</li>
          </ol>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-white">
              ...
              <h1 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6">
                Office Furniture in Vadodara
              </h1>
              <p className="text-lg md:text-xl mb-6 text-white/90">
                Office furniture making in Vadodara. Trusted by thousands of customers. 
              ...
              <div className="hidden md:flex flex-col sm:flex-row gap-4">
                ...
                <a
                  href={`https://wa.me/919313982980?text=Hi, I need Office Furniture service in Vadodara`}
            ...
            <div className="bg-white rounded-2xl p-6 shadow-2xl">
              <BookingForm title={`Get Free Office Furniture Quote`} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Choose Us for Office Furniture?
          </h2>
          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                About Office Furniture Services in Vadodara
              </h2>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                Why Office Furniture Matters for Your Property
              </h3>
              <div className="text-gray-700 leading-relaxed space-y-4">
                <p>
                  Professional office furniture services are essential for maintaining and enhancing your property in Vadodara. 
                  Whether you own a residential property in Alkapuri, a commercial establishment in Sayajigunj, or an industrial 
                  facility in Makarpura GIDC, quality office furniture work ensures longevity, aesthetics, and value.
                </p>
                <p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Choose Vadodara Mistry for Office Furniture?
          </h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Our Office Furniture Process
          </h2>
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            We follow a systematic approach to ensure quality results for every office furniture project
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Office Furniture Service Areas in Vadodara
          </h2>
          <p className="text-center text-gray-600 mb-12">
            We provide office furniture services across all Vadodara areas
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            Find answers to common questions about our office furniture services in Vadodara
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div>
              <h2 className="text-3xl font-bold mb-4">
                Book Office Furniture Service Today
              </h2>
      ...
      <section className={`${config.gradient} py-16`}>
        <div className="container mx-auto px-4 text-center text-white">
          <h2 className="text-3xl font-bold mb-4">
            Need Office Furniture Service in Vadodara?
          </h2>
